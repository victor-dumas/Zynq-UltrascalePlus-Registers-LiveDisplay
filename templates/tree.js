// Copyright Â© 2009-2016, Rob Chandler.
...
/* Original Copyright Â© 2002 Jean-Claude Manoli [jc@manoli.net]
 *
...
imgPlus.src="{{url_for('static', filename='treenodeplus.gif')}}";
var imgMinus = new Image();
imgMinus.src="{{url_for('static', filename='treenodeminus.gif')}}";
var imgDot = new Image();
imgDot.src="{{url_for('static', filename='treenodedot.gif')}}";    //rwc - fixed. Was... imgPlus.src="{{url_for('static', filename='treenodedot.gif')}}";
...
//
	...
	for(var i=0; i < el.childNodes.length; i++)
	{
		...
		else if (child.className == "treeSubnodesHidden")
		{
			...
			imgEl.src = "{{url_for('static', filename='treenodeminus.gif')}}";
			break;
		}
		else if (child.className == "treeSubnodes")
		{
			child.className = "treeSubnodesHidden";
			imgEl.src = "{{url_for('static', filename='treenodeplus.gif')}}";
			break;
		}
	}
}
...
function flattoc_Expand(i) {  //pass toc flat index
	if (_toc_flat[i].xDiv !== null && _toc_flat[i].xDiv.className == "treeSubnodesHidden") {
        ...
        _toc_flat[i].xImg.src = "{{url_for('static', filename='treenodeminus.gif')}}";
	}
}
function flattoc_Collapse(i) {  //pass toc flat index
	if (_toc_flat[i].xDiv !== null && _toc_flat[i].xDiv.className == "treeSubnodes") {
		...
		_toc_flat[i].xImg.src = "{{url_for('static', filename='treenodeplus.gif')}}";
	}
}
